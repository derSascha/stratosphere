...
public class QosGraphFixture2 {
    ...
    private void createJobGraph() throws JobGraphDefinitionException {
        ...
        jobTaskVertex1.connectTo(jobTaskVertex2, ChannelType.NETWORK, CompressionLevel.NO_COMPRESSION,
                DistributionPattern.POINTWISE);
        jobTaskVertex2.connectTo(jobTaskVertex3, ChannelType.NETWORK, CompressionLevel.NO_COMPRESSION,
                DistributionPattern.POINTWISE);
        jobTaskVertex3.connectTo(jobOutputVertex, ChannelType.NETWORK, CompressionLevel.NO_COMPRESSION,
                DistributionPattern.BIPARTITE);
    }
