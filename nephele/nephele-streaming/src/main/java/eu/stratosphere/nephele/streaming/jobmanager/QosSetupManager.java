...
import eu.stratosphere.nephele.streaming.taskmanager.qosmodel.ProfilingGraphFactory;
import eu.stratosphere.nephele.streaming.taskmanager.qosmodel.ProfilingSequence;

public class QosSetupManager {

	private static final Log LOG = LogFactory
			.getLog(QosSetupManager.class);
	...
	public QosSetupManager(ExecutionGraph executionGraph) {
